...
public class ChangeTimeValueController {
    ...
    @FXML
    private TextField textFieldOriginalValue;
    @FXML
    private TextField textFieldActualValue;
    @FXML
    private TextField textFieldShifting;
    @FXML
    private ChoiceBox<String> choiceBoxShifting;
    @FXML
    private ChoiceBox<String> choiceBoxUTC_Format;
    @FXML
    private Button buttonChangeUTC_Format;
    @FXML
    private Toggle toggleUTC_Date;
    @FXML
    private Toggle toggleJD_Date;
    @FXML
    private ToggleGroup toggleGroupDateMode;
     ...
     */
    @FXML
    private void handleClickToggleDateMode() {
        Toggle before;
     ...
     */
    @FXML
    private void handleClickButtonUseDefaultValue() {
        stage.close();
    }
     ...
     */
    @FXML
    private void handleClickButtonCopyToActual() {
        if (card.getDateValue().isCreatedFromClassicDate()) {
     ...
     */
    @FXML
    private void handleClickButtonChangeUTC_Format() {
