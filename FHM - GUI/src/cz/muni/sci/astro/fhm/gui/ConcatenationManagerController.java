...
public class ConcatenationManagerController
{
    ...
    @FXML private ListView<FitsCard> listViewCardValues;
    @FXML private ListView<String> listViewConcatenation;
    @FXML private Button buttonCardValuesAdd;
    @FXML private Button buttonCustomValueAdd;
    @FXML private Button buttonCopyValue;
    @FXML private Button buttonRemove;
    @FXML private Button buttonMoveUp;
    @FXML private Button buttonMoveDown;
    @FXML private TextField textFieldCustomValue;
    @FXML private TextField textFieldGlue;
    @FXML private ChoiceBox<FitsCard> choiceBoxTarget;
     ...
     */
    @FXML private void handleClickButtonCardValuesAdd()
    {
     ...
     */
    @FXML private void handleClickButtonCustomValueAdd()
    {
     ...
     */
    @FXML private void handleClickButtonCopyValue()
    {
     ...
     */
    @FXML private void handleClickButtonRemove()
    {
     ...
     */
    @FXML private void handleClickButtonUseConcatenation()
    {
     ...
     */
    @FXML private void handleClickButtonPreviewConcatenation()
    {
     ...
     */
    @FXML private void handleClickButtonCancel()
    {
        stage.close();
    }
